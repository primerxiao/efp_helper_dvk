 ...
 */
@Deprecated
public class DubboProviderAction extends AnAction {
    @Override
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        if (fileType instanceof JavaFileType) {
            ...
            if (moduleForFile.getName().endsWith(".impl")) {
                ...
                operaModule = getImplModule(moduleForFile);
            }
            String[] split = operaModule.getName().split("\\.");
            String xmlName = "dubbo-provider-"+split[0]+"-"+split[1]+".xml";
            EfpData efpData = new EfpData(operaModule.getName(),xmlName,1);
            ...
            if (filesByName.length > 0) {
                ...
                String idValue = initCap(className)+ "Provider";
                ...
                WriteCommandAction.runWriteCommandAction(e.getProject(), () -> {
                    ...
                    xmlTag.setAttribute("ref", initCap(finalClassName));
