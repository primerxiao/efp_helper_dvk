...
<mapper namespace="com.fdb.a.${simpleBaseModuleNameMethod(x)}.infra.persistence.mapper.${generateInfo.basicClassName}Mapper">
    ...
    <select id="queryByPk" resultMap="${baseClassName?uncap_first}List" parameterType="com.fdb.a.${simpleBaseModuleNameMethod(x)}.infra.persistence.po.${generateInfo.basicClassName}PO">
        select
